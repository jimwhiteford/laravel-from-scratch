    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
            <div x-data="{ open: false }" @click.away="open = false">
                ...
                <div x-show="open" class="py-2 absolute bg-gray-100 mt-2 rounded-xl w-full z-50 max-h-52 overflow-auto"
                    style="display:none">
                    <a href="/"
                        class="block text-left px-3 text-sm leading-6 hover:bg-blue-300 focus:bg-blue-500 hover:text-white focus:text-white">All</a>
                    @foreach ($categories as $category)
                        <a href="/categories/{{ $category->slug }}"
                            class="block text-left px-3 text-sm leading-6 hover:bg-blue-300 focus:bg-blue-500 hover:text-white focus:text-white
